...
const pt: RomeContent = {
  ...
  attractions: [
    ...
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "O bairro mais agitado e 'cool' de Roma, localizado entre o Coliseu e o centro histórico. Ruelas medievais que hoje abrigam lojas vintage, ateliês de designers independentes, bares artesanais e o popular Mercato Monti aos fins de semana. É o bairro preferido dos jovens romanos e dos viajantes que querem fugir do circuito turístico convencional sem sair do coração da cidade.",
      duration: "2–3 horas",
      cost: "Gratuito",
      image: "https://images.unsplash.com/photo-1548783300-77a5b3a01ccd?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "Bairro histórico da antiga classe operária de Roma, hoje considerado a capital gastronômica da cidade. Abriga o Mercato di Testaccio — um dos mercados de alimentação mais autênticos da Itália —, as melhores trattorias de quinto quarto (a culinária romana de miúdos) e uma vida noturna genuína nos antigos matadouros reconvertidos em clubs e espaços culturais.",
      duration: "2–3 horas",
      cost: "Gratuito",
      image: "https://images.unsplash.com/photo-1578846655962-b13a2b60ef66?w=900&q=80",
    },
    {
      ...
      profiles: ["friends"],
      description:
        "O bairro mais alternativo e boêmio de Roma, preferido pelos artistas, universitários e pela comunidade criativa da cidade. Ruas cobertas de grafites de alto nível, bares independentes com aperitivo barato, cinematecas e espaços culturais underground. Bem longe do centro turístico, mas a 15 minutos de metrô — uma imersão na Roma que os guias nunca mostram.",
      duration: "2–3 horas",
      cost: "Gratuito",
      image: "https://images.unsplash.com/photo-1568822617270-2c1e0f5f0b0c?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "Construído por Mussolini nos anos 1930–40 para sediar a Exposição Universal de 1942 — que nunca aconteceu por causa da guerra. Hoje é um bairro residencial elegante com lagos artificiais, museus e uma arquitetura racional fascista de proporções monumentais completamente diferente de tudo em Roma. O Palazzo della Civiltà Italiana — o 'Coliseu Quadrado' — é o símbolo mais fotografado do bairro.",
      duration: "2–3 horas",
      cost: "Gratuito",
      image: "https://images.unsplash.com/photo-1600200424-7e8d25b8cedc?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "Um bairro residencial construído nos anos 1920 com o conceito de 'cidade-jardim': edifícios baixos em estilo eclético agrupados em lotti (pátios coletivos) com jardins compartilhados. Completamente fora do roteiro turístico, é um dos bairros mais fotogênicos e autênticos de Roma — onde ainda se vê a vida de bairro romana dos inícios do século XX quase intacta.",
      duration: "1,5–2 horas",
      cost: "Gratuito",
      image: "https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "O bairro da Roma contemporânea, com dois dos projetos de arquitetura mais importantes da Itália moderna. O MAXXI, projetado por Zaha Hadid (Prêmio Pritzker) e inaugurado em 2010, é o museu nacional de arte contemporânea italiana. O Auditorium Parco della Musica, de Renzo Piano, é o maior complexo musical da Europa e o coração da vida cultural romana.",
      duration: "2–3 horas",
      cost: "Parque gratuito (MAXXI €12)",
      image: "https://images.unsplash.com/photo-1571462574-a9e49b8f19a3?w=900&q=80",
    },
    // Experiences
    {
    ...
    {
      name: "Ostia Antica",
      neighborhood: "Ostia Antica",
      category: "experience",
      weather: "outdoor",
      profiles: ["family", "couple", "friends"],
      description:
        "A antiga cidade portuária de Roma, abandonada no século IV e soterrada pela areia do Tibre, emergiu em escavações do século XX num estado de conservação comparável — e em muitos aspectos superior — ao de Pompéia. Ruas inteiras com calçamento original, termas, teatros, templos, tabernas e mosaicos permanecem de pé. A 30 km do centro, acessível de metrô, e com uma fração do movimento turístico de Pompéia.",
      duration: "3–4 horas",
      cost: "€12",
      image: "https://images.unsplash.com/photo-1543002588-84ebe14a5a8e?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "As ruínas das gigantescas termas públicas construídas pelo imperador Caracalla em 217 d.C. — capazes de atender 1.500 pessoas simultaneamente em salas de banho, ginásios, bibliotecas e jardins. A escala das abóbadas e paredes ainda de pé é absolutamente impressionante. No verão, o Teatro dell'Opera di Roma realiza temporadas de ópera ao ar livre com as ruínas iluminadas ao fundo — uma das experiências mais extraordinárias de Roma.",
      duration: "1,5–2 horas",
      cost: "€8",
      image: "https://images.unsplash.com/photo-1569930784474-e1f6c4e73aad?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "O palácio dourado do imperador Nero, construído após o grande incêndio de Roma em 64 d.C., escondido sob o Monte Oppio ao lado do Coliseu. Redescoberto no Renascimento — Rafael e Michelangelo o visitaram clandestinamente — o complexo recebe hoje visitas com realidade aumentada que reconstituem digitalmente os ambientes originais. Uma das experiências mais únicas e menos conhecidas de Roma.",
      duration: "1–1,5 horas",
      cost: "€16 (reserva obrigatória)",
      image: "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"],
      description:
        "O maior e mais famoso mercado de pulgas da Itália, realizado todos os domingos desde 1945 nas ruas próximas à Porta Portese, em Trastevere. Centenas de barracas vendem antiguidades, roupas vintage, livros usados, discos de vinil, objetos curiosos e bugigangas de todo tipo. Uma imersão autêntica na cultura popular romana, longe dos percursos turísticos.",
      duration: "2–3 horas",
      cost: "Gratuito (entrada)",
      image: "https://images.unsplash.com/photo-1579033461380-adb47c35ef55?w=900&q=80",
    },
    {
      name: "Tivoli — Villa d'Este e Villa Adriana",
      neighborhood: "Tivoli (30 km de Roma)",
      category: "experience",
      weather: "outdoor",
      profiles: ["family", "couple", "friends"],
      description:
        "A 30 km de Roma, a cidade de Tivoli abriga dois Patrimônios Mundiais da UNESCO numa distância de poucos quilômetros. Villa d'Este (século XVI) tem jardins renascentistas com mais de 500 fontes, cascatas e jogos d'água — a inspiração original para todos os jardins barrocos europeus. Villa Adriana (século II d.C.) são as ruínas da villa particular do imperador Adriano, maior que muitas cidades romanas da época.",
      duration: "Dia inteiro",
      cost: "Villa d'Este €10 · Villa Adriana €10",
      image: "https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?w=900&q=80",
    },
  ],
  top5: [
...
const en: RomeContent = {
  ...
  attractions: [
    ...
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "Rome's coolest neighbourhood, located between the Colosseum and the historic centre. Medieval alleyways now lined with vintage shops, independent designers' studios, craft bars and the popular Mercato Monti at weekends. The favourite haunt of young Romans and travellers looking to escape the tourist circuit without leaving the heart of the city.",
      duration: "2–3 hours",
      cost: "Free",
      image: "https://images.unsplash.com/photo-1548783300-77a5b3a01ccd?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "Rome's historic working-class neighbourhood, today considered the gastronomic capital of the city. Home to the Mercato di Testaccio — one of Italy's most authentic food markets —, the best trattorias serving quinto quarto (Roman offal cuisine) and a genuine nightlife scene in the former slaughterhouses converted into clubs and cultural spaces.",
      duration: "2–3 hours",
      cost: "Free",
      image: "https://images.unsplash.com/photo-1578846655962-b13a2b60ef66?w=900&q=80",
    },
    {
      ...
      profiles: ["friends"] as ProfileTag[],
      description:
        "Rome's most alternative and bohemian neighbourhood, the favourite of artists, students and the city's creative community. Streets covered in high-quality street art, independent bars with cheap aperitivo, arthouse cinemas and underground cultural spaces. Far from the tourist centre but just 15 minutes by metro — a dive into the Rome that guides never show.",
      duration: "2–3 hours",
      cost: "Free",
      image: "https://images.unsplash.com/photo-1568822617270-2c1e0f5f0b0c?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "Built by Mussolini in the late 1930s to host the 1942 World's Fair — which never took place due to the war. Today it is an elegant residential district with artificial lakes, museums and a monumental rationalist architecture completely unlike anything else in Rome. The Palazzo della Civiltà Italiana — the 'Square Colosseum' — is the neighbourhood's most photographed landmark.",
      duration: "2–3 hours",
      cost: "Free",
      image: "https://images.unsplash.com/photo-1600200424-7e8d25b8cedc?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "A residential neighbourhood built in the 1920s on the garden city concept: low-rise eclectic buildings grouped around lotti (collective courtyards) with shared gardens. Completely off the tourist trail, it is one of Rome's most photogenic and authentic areas — where early 20th-century Roman neighbourhood life remains almost intact.",
      duration: "1.5–2 hours",
      cost: "Free",
      image: "https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "The neighbourhood of contemporary Rome, home to two of modern Italy's most important architectural projects. The MAXXI, designed by Zaha Hadid (Pritzker Prize) and opened in 2010, is the national museum of 21st-century art. The Auditorium Parco della Musica by Renzo Piano is the largest music complex in Europe and the heart of Rome's cultural life.",
      duration: "2–3 hours",
      cost: "Park free (MAXXI €12)",
      image: "https://images.unsplash.com/photo-1571462574-a9e49b8f19a3?w=900&q=80",
    },
    // Experiences
    {
    ...
    },
    {
      ...
      profiles: ["family", "couple", "friends"] as ProfileTag[],
      description:
        "Ancient Rome's port city, abandoned in the 4th century and buried under Tiber silt, emerged from 20th-century excavations in a state of preservation comparable — and in many respects superior — to Pompeii. Entire streets with original paving, baths, theatres, temples, taverns and mosaics still stand. Just 30 km from the centre, accessible by metro, and with a fraction of Pompeii's tourist crowds.",
      duration: "3–4 hours",
      cost: "€12",
      image: "https://images.unsplash.com/photo-1543002588-84ebe14a5a8e?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "The ruins of the enormous public baths built by Emperor Caracalla in 217 AD — capable of serving 1,500 people simultaneously across bathing halls, gymnasia, libraries and gardens. The scale of the still-standing vaults and walls is absolutely staggering. In summer, the Teatro dell'Opera di Roma stages open-air opera seasons with the illuminated ruins as a backdrop — one of Rome's most extraordinary experiences.",
      duration: "1.5–2 hours",
      cost: "€8",
      image: "https://images.unsplash.com/photo-1569930784474-e1f6c4e73aad?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "Emperor Nero's golden palace, built after the great fire of Rome in 64 AD, hidden beneath the Oppian Hill next to the Colosseum. Rediscovered during the Renaissance — Raphael and Michelangelo visited it clandestinely — the complex now offers guided visits with augmented reality that digitally reconstructs the original rooms and decoration. One of Rome's most unique and least-known experiences.",
      duration: "1–1.5 hours",
      cost: "€16 (advance booking required)",
      image: "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=900&q=80",
    },
    {
      ...
      profiles: ["couple", "friends"] as ProfileTag[],
      description:
        "Italy's largest and most famous flea market, held every Sunday since 1945 along the streets near Porta Portese in Trastevere. Hundreds of stalls sell antiques, vintage clothing, second-hand books, vinyl records, curiosities and all kinds of odds and ends. An authentic immersion in Roman popular culture, well away from tourist itineraries.",
      duration: "2–3 hours",
      cost: "Free (entry)",
      image: "https://images.unsplash.com/photo-1579033461380-adb47c35ef55?w=900&q=80",
    },
    {
      name: "Tivoli — Villa d'Este & Villa Adriana",
      neighborhood: "Tivoli (30 km from Rome)",
      category: "experience" as const,
      weather: "outdoor" as const,
      profiles: ["family", "couple", "friends"] as ProfileTag[],
      description:
        "Just 30 km from Rome, the town of Tivoli holds two UNESCO World Heritage Sites within a few kilometres of each other. Villa d'Este (16th century) has Renaissance gardens with over 500 fountains, cascades and water features — the original inspiration for all European Baroque gardens. Villa Adriana (2nd century AD) are the ruins of Emperor Hadrian's private estate, larger than many Roman cities of its time.",
      duration: "Full day",
      cost: "Villa d'Este €10 · Villa Adriana €10",
      image: "https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?w=900&q=80",
    },
